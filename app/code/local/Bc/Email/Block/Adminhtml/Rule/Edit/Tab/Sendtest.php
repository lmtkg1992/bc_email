<?php
class Bc_Email_Block_Adminhtml_Rule_Edit_Tab_Sendtest extends Mage_Adminhtml_Block_Widget_Form
{
    public function _prepareForm(){
        ...
        $fieldset = $form->addFieldset('email_sendtest', array('legend' => $this->__('Send test email to')));
        ...
        $fieldset = $form->addFieldset(
            'email_sendtest_objects', array('legend' => $this->__('Test object IDs'))
        );
